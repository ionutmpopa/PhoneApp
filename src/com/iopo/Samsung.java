...
public abstract class Samsung implements Phone{
    ...
    private List<Contact> contactList6;
    private List<String> callHistory6;
    private List<MessageHistory> messageHistory;
    private double remainingBattery;


    public Samsung(String color, String material, String imei, double batteryLife) {
        this.color = color;
        this.material = material;
        this.imei = imei;
        this.batteryLife = batteryLife;
        this.remainingBattery = batteryLife;
        this.contactList6 = new LinkedList<>();
        this.callHistory6 = new LinkedList<>();
    ...
    private void checkDuplicateContact (Contact contact) {
        ...
        if (contactList6.contains(contact)) {
